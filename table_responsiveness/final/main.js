...
if (!document.querySelector('link[href*="swiper-bundle.min.css"]')) {
    vwo_$('head').append('<link rel="stylesheet" class="external-css-link" type="text/css" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css">');
}

// Load Swiper JS and then execute your main code
vwo_$.getScript("https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js", function(data, textStatus, jqxhr) {
    // Your main VWO test code goes here
    (function() {
        'use strict';
        
        console.log('Swiper loaded, starting AB-Test');
        ...
        // Simplified utils since Swiper is already loaded
        const utils = {
            waitForSwiper: function (callback) {
                // Swiper should already be loaded, but check just in case
                if (typeof window.Swiper !== 'undefined') {
                    callback();
                } else {
                    setTimeout(() => utils.waitForSwiper(callback), 100);
                }
            }
        };
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.length > 0) {
                        ...
                        // Initialize Swiper directly since it's already loaded
        ...
        function initMobileCards() {
            ...
            function initializeMobileLayout() {
                ...
                if (document.querySelector('.mobile-layout')) {
                    console.log('Mobile layout already exists, skipping initialization');
                    return;
                }
