(function() {
    ...
    runWhenReady(function() {
        console.log("Cookie consent script running (vwo_script.js)");
        initCookieConsent();
    });
    ...
    function initCookieConsent() {
        ...
        // Event delegation for notice description span clicks
        ...
        // Event delegation for btn-close clicks
        document.addEventListener('click', function(event) {
        ...
        // Re-run on VWO mutation if applicable
        if (window._vwo_code) {
