        ...
        utils.waitForJquery(function () {
            jQuery('body').append(`
                <section class="ATC">
                    ...
                    <div class="ATC-loading">
                        <img src="https://env-wirefence-wfpremstg.kinsta.cloud/wp-content/themes/emallshop-child/assets/images/ajax-loader-green.gif" />
                    ...
                    <div class="ATC-popup">
                        ...
                        <div class="ATC-popup__inner">
                            <div class="ATC-popup__product">
                                ...
                                <p class='atc-popup__title'>Your product has been added to cart!</p>
                                <ul>
            ...
            const showSuccess = function () {
                ...
                const noticeText = jQuery('.col-md-2 .header-right .woocommerce-notice').text().trim() || 
                                    jQuery('.col-xs-3 .header-right .woocommerce-notice').text().trim() || 
                                    'Your product has been added to cart!';
                
                console.log(noticeText);
                jQuery('.ATC-popup__product p').html(noticeText);
            };
